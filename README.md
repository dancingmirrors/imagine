...
```
sudo apt-get install -y gir1.2-gtk-3.0 libcairo2-dev libgirepository1.0-dev libgtk-3-0 pkg-config python3-dev python3-gi python3-gi-cairo python3-pip python3-venv ; sudo make install ; imagine
```
